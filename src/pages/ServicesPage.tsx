...
const services = [
  ...
  },
  {
    ...
    tagline: 'Real Estate Compliance, Perfected.',
    description: 'Navigate RERA regulations with absolute certainty. From initial project registration to quarterly updates and final closure, non-compliance can halt your project. We manage the entire RERA lifecycle.',
    features: [
  ...
  },
  {
    ...
    tagline: 'Strategic Decision Making, Quantified.',
    description: 'Robust financial models designed to forecast performance, assess risk, and guide your most critical business decisions with precision and clarity.',
    features: [
  ...
  },
  {
    ...
    tagline: 'Empowering Capital, Realized.',
    description: 'Securing capital for large-scale projects demands rigorous structuring and market insight. We connect you with the right lenders and investors, ensuring your project is fully funded with optimal terms.',
    features: [

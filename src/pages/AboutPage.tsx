        ...
        <div className="relative z-10 aw-container py-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-white/60 text-base md:text-lg max-w-xl leading-relaxed mb-8 font-normal">
              Awooraa Global Professional Services was founded on a simple conviction: growing companies deserve a single integrated partner across Finance, Digital, and People — not fragmented advisors.
            </p>

...
const pillars = [
  {
    ...
    services: ['Accounting & Bookkeeping', 'GST & Tax Filing', 'Virtual CFO Services', 'MIS Reporting', 'Financial Planning'],
  ...
  },
  {
    ...
    services: ['Full-Stack Web Development', 'iOS & Mobile App Development', 'SEO Management', 'ERP Solutions', 'CRM Implementation'],
  ...
  },
  {
    ...
    services: ['Recruitment & Hiring', 'Payroll Processing', 'HR Compliance', 'Employee Management', 'Performance Management'],

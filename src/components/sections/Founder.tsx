          ...
          >
            <div className="relative rounded-2xl overflow-hidden aspect-[4/5] border border-white/10 shadow-[0_8px_30px_rgba(0,0,0,0.5)]">
              <img 
                ...
                onError={(e) => {
                  e.currentTarget.src = "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=800&q=80"
                }}
              />
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <p className="text-aw-tan text-sm font-medium tracking-wide">Founder & Chief Executive Officer</p>
              </div>
            </div>
